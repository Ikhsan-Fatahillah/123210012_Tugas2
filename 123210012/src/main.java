...
class GUI extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent e){
       if(e.getSource() == count){
           ...
           Lpp.setText("Square area : " + strLuas);
           
           String strKeliling = Integer.toString(KPersegi);
           Kpp.setBounds(10,160,180,20);
           Kpp.setText("Square circumference : " + strKeliling);
           
           String strVolume = Integer.toString(VBalok);
           Vb.setBounds(10,185,120,20);
           Vb.setText("Cuboid volume : " + strVolume);
           
           String strLPBalok = Integer.toString(LPBalok);
           LPbalok.setBounds(10,205,300,20);
           LPbalok.setText("Cuboid surface area : " + strLPBalok);
